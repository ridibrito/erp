-- =====================================================
-- CORTUS ERP - MIGRAÇÃO MANUAL PARA SUPABASE
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_two_factor_auth_updated_at') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_data_subject_requests_updated_at') THEN
...
-- CRM
('crm.clients.view', 'Visualizar clientes', 'crm', 'view', 'clients'),
('crm.clients.create', 'Criar clientes', 'crm', 'create', 'clients'),
('crm.clients.edit', 'Editar clientes', 'crm', 'edit', 'clients'),
('crm.clients.delete', 'Excluir clientes', 'crm', 'delete', 'clients'),
